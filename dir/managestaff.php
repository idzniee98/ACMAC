    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navigation" style="margin: 0% 0% .1% 82.5%;">
            ...
            <div class="card card-plain">
              <div class="card-header">
                ...
                <a href="insertstaff.php">
                  <div class="update ml-auto mr-auto" style="padding-left: 15px">
              ...
              <div class="card-body">
                <div style="font-weight:bold; font-size: 16px;" class="text-right">
                ...
                <div> <!--<div class="table-responsive">-->
                  <table class="table" id="myTable" >
                    <thead class="text-left text-primary">
                      ...
                      <th colspan="2" style="padding-left:3%">
                        Action
                      </th>
                    </thead>
                    <tbody>
