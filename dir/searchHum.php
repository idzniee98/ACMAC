            ...
            <div class="card card-plain">
              <?php
                ...
                if(isset($_POST['search'])){
                  ...
                  $sqlsearch = " SELECT * FROM dht11 WHERE humidity LIKE '%$searchq%'";
                  $output ='';
              ...
              <p class="card-title " style="font-size:16px;"><strong>Search By Humidity:
                <?php if($row2 = $result2->fetch_assoc()){?>
                  <a href="#" style="font-size:20px;">
                  <?php echo $row2['humidity']; ?>%</a></strong></p><?php
                }else{
