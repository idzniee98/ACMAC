            ...
            <div class="card card-plain">
              <?php
                ...
                if(isset($_POST['search'])){
                  ...
                  $sqlsearch = " SELECT * FROM dht11 WHERE heatindex LIKE '%$searchq%'";
                  $output ='';
              ...
              <p class="card-title " style="font-size:16px;"><a href="https://kestrelinstruments.com/mwdownloads/download/link/id/11" target="_blank">
                <i class="nc-icon nc-alert-circle-i fa-lg" data-toggle="tooltip" data-placement="top"
                  title="Click the icon to learn more about Heat Index..."></i></a><strong> Search By Heat Index:
                <?php if($row2 = $result2->fetch_assoc()){?>
                  <a href="#" style="font-size:20px;">
                    <?php echo $row2['heatindex']; ?><sup>o</sup>C</a></strong></p><?php
                  }else{
